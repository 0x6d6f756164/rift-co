...
export const business = {
  ...
  foundedStory:
    "Rift Co. started as three duffel bags of samples sold out of a van outside a warehouse show. We still design that way — a small run, worn hard, fixed if it fails, kept if it earns a place in rotation.",
};
